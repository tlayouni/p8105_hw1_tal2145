...
**Question\_2\_df is a data frame containing:**
  ...
  - The variable x has a mean of -0.0176415, a median of 0.0229782 and a
    standard deviation of 1.0270433
...
#### Question 2, part 2: Creating scatterplots of variables x vs. y using ggplot
  ...
  - The third has color points corresponding to the factor
variable
